...
def gravity(dots,k,t,a):
	...
	with imageio.get_writer('Gravity.gif', mode='I', **kwargs ) as writer:
		...
		while k1>=1:
			...
			plt.axis([0, 1, 0, 1])
			plt.text(0.05, 0.95, 'Force fading coefficient: '+str(k1),fontsize=10)
			plt.plot([dots4[0],dots3[0]],[dots4[1],dots3[1]],c=(0.25,0.0,0.0,1.0),lw=1.0)
			plt.plot([dots3[0],dots2[0]],[dots3[1],dots2[1]],c=(0.5,0.0,0.0,1.0),lw=2.0)
			plt.plot([dots2[0],dots1[0]],[dots2[1],dots1[1]],c=(0.75,0.0,0.0,1.0),lw=3.0)
			plt.plot([dots1[0],dots[0]],[dots1[1],dots[1]],c=(1.0,0.0,0.0,1.0),lw=4.0)
